...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{(!empty(Auth::user()->image))?asset('upload/user_images/'.Auth::user()->image):asset('upload/no_image.png')}}" 
  ...
  <footer class="main-footer">
    <strong>Copyright &copy;  techIt<a href="http://adminlte.io"></a>.</strong>
    <div class="float-right d-none d-sm-inline-block">
      <b>design & developed by </b> techIt
    </div>
  </footer>
