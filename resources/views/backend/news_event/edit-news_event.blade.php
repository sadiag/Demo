        ...
        <div class="row">
          ...
          <section class="col-md-12">
           ...
           <a class="btn btn-success float-right btn-sm" href="{{route('news_events.view')}}">
            ...
            <form method="post" action="{{route('news_events.update',$editData->id)}}" id="myForm"
            enctype="multipart/form-data">
              @csrf
                 ...
                 <div class="form-group col-md-8">
                      ...
                      <textarea name="long_title" class="form-control" rows="5"
                      value="{{$editData->long_title}}" ></textarea>
                    </div>
                    ...
                    <div class="form-group col-md-2">
                        <img id="showImage" src="{{(!empty($editData->image))?asset('upload/news_images/'.$editData->image):asset('upload/no_image.png')}}" 
