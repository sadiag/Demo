              ...
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><img src="{{(!empty($news->image))?asset('upload/news_images/'.$news->image):asset('upload/no_image.png')}}"
                    width="120px" height="130px"></td>
                    <td>{{$news->short_title}}</td>
                    <td>{{$news->long_title}}</td>
                    <td>
                       <a title="Edit" class="btn btn-sm btn-primary" href=
                       "{{route('news_events.edit',$news->id)}}">
                        <i class="fas fa-edit"></i></a>
                        <a title="delete" id="delete" class="btn btn-sm btn-danger" 
                        href="{{route('news_events.delete',$news->id)}}">
