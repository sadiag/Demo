        ...
        <div class="row">
          ...
          <section class="col-md-12">
           ...
           <a class="btn btn-success float-right btn-sm" href="{{route('sliders.view')}}">
            ...
            <form method="post" action="{{route('sliders.update',$editData->id)}}" id="myForm"
              ...
              @csrf
                 ...
                 <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-2">
                        <img id="showImage" src="{{(!empty($editData->image))?asset('upload/slider_images/'.$editData->image):asset('upload/no_image.png')}}" 
